module.exports = {
  ...
  overrides: [
    ...
    {
      // Các service và script là CommonJS thuần. Luật no-var-requires sinh ra để
      // chặn `require()` lọt vào mã TypeScript, nhưng ở đây nó kêu trên mọi tệp
      // .js đúng chuẩn — hơn 40 lỗi giả làm chìm mất lỗi thật.
      files: ['**/*.js', '**/*.cjs'],
