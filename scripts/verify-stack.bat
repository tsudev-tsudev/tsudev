...
IF ERRORLEVEL 1 (
  ...
  docker compose logs --tail=200 keycloak minio postgres user-service content-service storage-service frontend-main frontend-forum > verify-output\compose-logs.txt 2>&1
